        ...
        for episode in range(num_episodes):
            ...
            for timestep in tqdm(range(max_timesteps),
                ...
                if isinstance(prompts, dict):
                    attention_mask = prompts['attention_mask'].to(torch.cuda.current_device())
                    prompts = prompts['input_ids'].to(torch.cuda.current_device())
                    prompts = dict(input_ids=prompts, attention_mask=attention_mask)
...
class PPOTrainer(Trainer):
    ...
    def training_step(self, experience: Experience) -> Dict[str, float]:
        ...
        action_log_probs = self.actor(experience.sequences, attention_mask=experience.attention_mask)
